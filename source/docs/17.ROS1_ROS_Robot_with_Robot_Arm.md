...
<img src="../_static/media/chapter_17/section_1/image3.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_17/section_2/image5.png" class="common_img" style="width:600px;"/>

<img src="../_static/media/chapter_17/section_2/image6.png" class="common_img" style="width:600px;"/>
...
<img src="../_static/media/chapter_17/section_2/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_3/image2.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_17/section_3/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_4/image2.png" class="common_img" />
...
(2) Click the icon at the top-left corner <img src="../_static/media/chapter_17/section_4/image4.png" style="width:70px" /> of the desktop to open the Terminator terminal.
...
(8) Click-on <img src="../_static/media/chapter_17/section_4/image11.png"  style="width:70px"/> to open the command-line terminal.
...
(10) Wait a few moments until you hear a short beep from the buzzer, indicating the system has restarted. Open the terminal again <img src="../_static/media/chapter_17/section_4/image4.png" style="width:70px" /> and run the following command to test the walking behavior:
...
<img src="../_static/media/chapter_17/section_5/image2.png" class="common_img" />
...
(1) Power on the robot, then follow the steps in [3. Remote Tool Installation Connection → 3.3 Docker Container Introduction and Entry](3.Remote_Tool_Installation_Connection.md#docker-container-introduction-and-entry) and [3.4 ROS Version Switch Tool Guide](3.Remote_Tool_Installation_Connection.md#ros-version-switch-tool-guide) to connect via the VNC remote control software and switch to the ROS 1 environment.

(2) Open the Terminator terminal by clicking the system desktop icon <img src="../_static/media/chapter_17/section_4/image4.png" style="width:70px" />.
...
<img src="../_static/media/chapter_17/section_5/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_8/image30.png" class="common_img" />
...
You can refer to the document [Virtual Machine Installation](resources_download.md) in the same directory for instructions on installing the virtual machine.
...
<img src="../_static/media/chapter_17/section_10/image2.png" class="common_img" />

(2) Open a virtual machine.

<img src="../_static/media/chapter_17/section_10/image3.png" class="common_img" />

(3) Select the folder where virtual machine file is extracted, then open it.

<img src="../_static/media/chapter_17/section_10/image4.png" class="common_img" />

(4) Enter the name and set the storage path for virtual machine. Then click `Import`.

<img src="../_static/media/chapter_17/section_10/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image6.png" class="common_img" />

(2) Return to the virtual machine interface, and click `edit->virtual machine editor`.

<img src="../_static/media/chapter_17/section_10/image7.png" class="common_img" />

(3) Select the wireless network card to be bridged. Then click OK.

<img src="../_static/media/chapter_17/section_10/image8.png" class="common_img" />

<img src="../_static/media/chapter_17/section_10/image9.png" class="common_img" />

(4) Open virtual machine, and power on virtual machine.

<img src="../_static/media/chapter_17/section_10/image10.png" class="common_img" />

(5) When entering the system desktop, right click the desktop and select `open in terminal`.

<img src="../_static/media/chapter_17/section_10/image11.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image16.png" class="common_img" />

* **PuppyPi Network Configuration**

(1) Get access to Raspberry Pi desktop via VNC.

(2) Click <img src="../_static/media/chapter_17/section_10/image17.png" /> or use shortcut **Ctrl+Alt+T** to open terminal.
...
<img src="../_static/media/chapter_17/section_10/image19.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image21.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image23.png" class="common_img" />

<p id="anchor_17_10_3"></p>
...
<img src="../_static/media/chapter_17/section_10/image26.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image27.png" class="common_img" />

<img src="../_static/media/chapter_17/section_10/image28.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image29.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image31.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image33.png" class="common_img" />

(7) Click `File->Open Config`.

<img src="../_static/media/chapter_17/section_10/image34.png" class="common_img" />

As shown in the following image, navigate to the corresponding path, select `navigation.rviz`, and then click `Open`.

<img src="../_static/media/chapter_17/section_10/image35.png" class="common_img" />

<img src="../_static/media/chapter_17/section_10/image36.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image37.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image38.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image39.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image40.png" class="common_img" />

### 17.10.5 Program Analysis

[Source Code](../_static/source_code/ros1/puppy_bringup.zip)
...
[/home/ubuntu/puppypi/src/puppy_bringup/launch/start_node_nav.launch](../_static/source_code/ros1/puppy_bringup.zip)
...
[/home/ubuntu/puppypi/src/puppy_navigation/launch/navigation.launch](../_static/source_code/ros1/puppy_navigation.zip)
...
(3) RVIZ configuration file for the robot dog virtual machine: [/home/puppy_sim/src/puppy_description/launch/rviz_with_urdf.launch](../_static/source_code/ros1/puppy_description.zip)

<img src="../_static/media/chapter_17/section_10/image46.png" class="common_img" />
...
The source code for this program is located in the Docker container：[/home/ubuntu/puppypi/src/puppy_with_arm/scripts/color_place_nav.py](../_static/source_code/ros1/puppy_with_arm.zip)
...
<img src="../_static/media/chapter_17/section_10/image61.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_10/image62.png" class="common_img" />

(4) After making the modifications, press the `Esc` key, enter the command `:wq`, and press Enter to save and exit.

<img src="../_static/media/chapter_17/section_10/image63.png" class="common_img" />

(5) Refer to [17.10.3 Start Navigation](#anchor_17_10_3) to restart the game and view the effects of the modification.
...
<img src="../_static/media/chapter_17/section_11/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image21.png" class="common_img" />


### 17.11.2 Inverse Kinematics Analysis of Robotic Arm

<img src="../_static/media/chapter_17/section_11/image3.png" class="common_img" />
...
The source code of this program is stored at: [/home/ubuntu/puppypi/src/puppy_common/kinematics sdk/arm kinematics/InverseKinematics.py](../_static/source_code/ros1/InverseKinematics.zip)
...
(2) Click the icon <img src="../_static/media/chapter_17/section_11/image5.png" style="width:70px" /> on the upper left corner to open the Terminator terminal.
...
<img src="../_static/media/chapter_17/section_11/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image11.png" class="common_img" />

(3) Next, calculate the cosPAC value, and then round it to four decimal places.

<img src="../_static/media/chapter_17/section_11/image12.png" class="common_img" />

(4) Check again whether the absolute value exceeds 1.

<img src="../_static/media/chapter_17/section_11/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image16.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image17.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image18.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image19.png" class="common_img" />
...
<img src="../_static/media/chapter_17/section_11/image20.png" class="common_img" />