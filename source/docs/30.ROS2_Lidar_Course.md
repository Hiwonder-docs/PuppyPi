...
There are three types of Lidar based on ranging principles: Triangulation Lidar, Pulse Lidar, and Coherent Lidar. The Lidar used by PuppyPi is a Pulse Lidar. Refer to the assembly tutorials for detailed installation steps: [LiDAR Assembly](https://youtu.be/etIpwoYnzdo).
