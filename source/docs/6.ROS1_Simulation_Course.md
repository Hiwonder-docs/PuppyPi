...
Virtual Machine PuppyPi_VM：[PuppyPi_VM](resources_download.md)
...
(2) Navigate to the directory "[**Software Tools->PuppyPi_VM.zip**](resources_download.md)". Then, open the virtual machine client. 
