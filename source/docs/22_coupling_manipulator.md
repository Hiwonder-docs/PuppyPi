...
(2) Input command and press Enter to open the PC software.
...
<img class="common_img" style="width:600px;" src="../_static/media/chapter_22/section_2/image11.png"  />
...
(3) Input command and press Enter to close auto-start program.

```bash
sudo ./.stop_ros.sh
```

(4) Input command and press Enter start robotic arm game.
...
(7) After closing the program, you still need to enter the command and press Enter to start the app auto-start service.
...
If the color recognition is inaccurate, please refer to "[**7. ROS1-AI Visual and Tracking Course->7.1 Color Threshold Adjustment**](https://docs.hiwonder.com/projects/PuppyPi/en/latest/docs/13_visual_recognition_and_tracking.html#color-threshold-adjustment)" for adjustment.
:::
...
(1) Input command to edit color recognition gripping program. Then press Enter.
...
(6) Input command and press Enter to start the auto-start program.
...
(9) After closing the game, you also need to enter the command and press Enter to start the app auto-start service. 
...
(10) Additionally, input command and press Enter to open the button detection service.
...
(9) After closing the game, you still need to enter the command and press Enter to start the app's auto-start service.
...
(10) Additionally, you need to input command and press Enter to start button detection service.
...
(1)  Input command and press Enter to edit the line following gripping program.
...
(4) Input command and press Enter to start the program.
...
(3) Input command and press Enter to switch to the directory containing the inverse kinematics program file.

```bash
cd puppypi/src/puppy_common/kinematics_sdk/arm_kinematics
```

(4) Input the command and press Enter to open the inverse kinematics program file.
