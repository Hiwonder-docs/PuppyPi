...
<img class="common_img" src="../_static/media/chapter_34/section_1.1/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_34/section_1.1/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_34/section_1.1/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_34/section_1.2/05/image11.png"  />
...
<img class="common_img" src="../_static/media/chapter_34/section_1.3/04/image11.png"   />
...
<img class="common_img" src="../_static/media/chapter_34/section_1.3/05/image5.png"  />
...
<img src="../_static/media/chapter_34/section_2/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_2/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_2/image15.png" class="common_img" />
...
(2) Double-click the `Terminator` icon on the Raspberry Pi desktop <img src="../_static/media/chapter_34/section_4/image2.png" style="width:0.534.4in;height:0.57361in" /> to launch the terminal and access the ROS2 development environment.
...
The main processing program is located at:  
[/home/ubuntu/ros2_ws/src/large_models/large_models/visual_patrol_demo.py](../_static/source_code/ros2/large_models.zip)
...
(2) Double-click the `Terminator` icon on the Raspberry Pi desktop <img src="../_static/media/chapter_34/section_6/image2.png" style="width:0.35903in;height:0.39653in" /> to launch the terminal and access the ROS2 development environment.
...
<img src="../_static/media/chapter_34/section_6/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_6/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_6/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_6/image8.png" class="common_img" />
...
(1) For the rules governing text responses and action design by the large model, please refer to the prompt settings within the program. Detailed instructions can be found in the PROMPT section of [/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_watch_dogs.py](../_static/source_code/ros2/large_models.zip).
...
[/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_watch_dogs.py](../_static/source_code/ros2/large_models.zip)
...
[/home/ubuntu/ros2_ws/src/large_models/large_models/launch/vllm_watch_dogs.launch.py](../_static/source_code/ros2/large_models.zip)
...
The robot must be connected to the internet, either in `STA (local network) mode` or `AP (direct connection) mode` via Ethernet. For detailed instructions on network configuration, please refer to the course [**3.5Network Configuration Instructions**](3.Remote_Tool_Installation_Connection.md#network-configuration-overview)
...
(2) Double-click the `Terminator` icon on the Raspberry Pi desktop <img src="../_static/media/chapter_34/section_7/image2.png" style="width:0.3334.in;height:0.36667in" /> to launch the terminal and access the ROS2 development environment.
...
<img src="../_static/media/chapter_34/section_7/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_7/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_7/image7.png" class="common_img" />

(8) Once this output appears, it means the current round of interaction has concluded. You can then say the wake word again to re-activate WonderEcho Pro and begin a new round of dialogue.

<img src="../_static/media/chapter_34/section_7/image8.png" class="common_img" />
...
[/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_gender_identification.py](../_static/source_code/ros2/large_models.zip)
...
[/home/ubuntu/ros2_ws/src/large_models/launch/vllm_gender_identification.launch.py](../_static/source_code/ros2/large_models.zip)
...
<img src="../_static/media/chapter_34/section_8/image2.png" class="common_img" />

(2) Mount the WonderEcho Pro and, temperature and humidity sensor onto the back of the robot.

<img src="../_static/media/chapter_34/section_8/image3.png" class="common_img" />
...
(2) Double-click the `Terminator` icon on the Raspberry Pi desktop <img src="../_static/media/chapter_34/section_8/image4.png" style="width:0.39444in;height:0.43542in" /> to launch the terminal and access the ROS2 development environment.
...
<img src="../_static/media/chapter_34/section_8/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_8/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_8/image9.png" class="common_img" />

(8) Once this output appears, it means the current round of interaction has concluded. You can then say the wake word again to re-activate WonderEcho Pro and begin a new round of dialogue.

<img src="../_static/media/chapter_34/section_8/image10.png" class="common_img" />
...
1. For the rules governing text responses and action design by the large model, please refer to the prompt settings within the program. Detailed instructions can be found in the PROMPT section of [/home/ubuntu/ros2_ws/src/large_models/large_models/llm_temperature.py](../_static/source_code/ros2/large_models.zip)
...
The main processing program is located at:  
[/home/ubuntu/ros2_ws/src/large_models/large_models/llm_temperature.py](../_static/source_code/ros2/large_models.zip)
...
[/home/ubuntu/ros2_ws/src/large_models/launch/llm_temperature.launch.py](../_static/source_code/ros2/large_models.zip)
...
(2) Double-click the `Terminator` icon on the Raspberry Pi desktop <img src="../_static/media/chapter_34/section_9/image2.png" style="width:0.41528in;height:0.45833in" /> to launch the terminal and access the ROS2 development environment.
...
<img src="../_static/media/chapter_34/section_9/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_9/image6.png" class="common_img" />

(8) Once this output appears, it means the current round of interaction has concluded. You can then say the wake word again to re-activate WonderEcho Pro and begin a new round of dialogue.

<img src="../_static/media/chapter_34/section_9/image7.png" class="common_img" />
...
1. For the rules governing text responses and action design by the large model, please refer to the prompt settings within the program. Detailed instructions can be found in the PROMPT section of [/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_with_camera.py](../_static/source_code/ros2/large_models.zip).
...
The main processing program is located at:  
[/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_with_camera.py](../_static/source_code/ros2/large_models.zip)
...
[/home/ubuntu/ros2_ws/src/large_models/large_models/launch](../_static/source_code/ros2/large_models.zip)
...
(2) Double-click the `Terminator` icon on the Raspberry Pi desktop <img src="../_static/media/chapter_34/section_10/image2.png" style="width:0.45278in;height:0.50069in" /> to launch the terminal and access the ROS2 development environment.
...
<img src="../_static/media/chapter_34/section_10/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_10/image6.png" class="common_img" />

(8) Once this output appears, it means the current round of interaction has concluded. You can then say the wake word again to re-activate WonderEcho Pro and begin a new round of dialogue.

<img src="../_static/media/chapter_34/section_10/image7.png" class="common_img" />
...
1. For the rules governing text responses and action design by the large model, please refer to the prompt settings within the program. Detailed instructions can be found in the PROMPT section of [/home/ubuntu/ros2_ws/src/large_models/large_models/llm_tracking.py](../_static/source_code/ros2/large_models.zip)
...
<img src="../_static/media/chapter_34/section_10/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_34/section_10/image11.png" class="common_img" />

(4) Press the `i` key to enter edit mode.

<img src="../_static/media/chapter_34/section_10/image12.png" class="common_img" />
...
[/home/ubuntu/ros2_ws/src/large_models/large_models/vllm_color_tracking.py](../_static/source_code/ros2/large_models.zip)

[/home/ubuntu/ros2_ws/src/large_models/large_models/llm_tracking.py](../_static/source_code/ros2/large_models.zip)

[/home/ubuntu/ros2_ws/src/large_models/large_models/puppy_controller.py](../_static/source_code/ros2/large_models.zip)
...
[/home/ubuntu/ros2_ws/src/large_models/large_models/launch/vllm_track_start.launch.py](../_static/source_code/ros2/large_models.zip)
