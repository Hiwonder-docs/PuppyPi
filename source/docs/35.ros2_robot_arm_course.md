...
<img src="../_static/media/chapter_35/section_1/media/image2.png"   /><img src="../_static/media/chapter_35/section_1/media/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_35/section_1/media/image8.png"  />

<img class="common_img" src="../_static/media/chapter_35/section_1/media/image9.png"  />
...
(1) Double-click the desktop icon <img class="common_img" src="../_static/media/chapter_35\section_2/media/image2.png"  />.

(2) Click **"Execute"** option in the pop-up prompt window to open the PC software.

<img class="common_img" src="../_static/media/chapter_35\section_2/media/image3.png"  />

* **Start device via command line**

(1) Click on the icon <img class="common_img" src="../_static/media/chapter_35\section_2/media/image4.png"  /> at the top left corner of the desktop, or use the shortcut "Ctrl+Alt+T" to open the command line terminal.
...
<img class="common_img" src="../_static/media/chapter_35\section_2/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_35\section_2/media/image8.png"  />
...
|:--:|:--:|
| **Icon** | **Function** |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image10.png"  /> | Servo ID number. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image11.png"  /> | The range of values used to adjust the angle position of the servo is from 500 to 2500. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image12.png"  /> | The range of values used to adjust the servo deviation is from -100 to 100. |
...
|:--:|:--:|
| **Icon** | **Function** |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image14.png"  /> | Action number. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image15.png"  /> | Action running time refers to the time taken to execute the action. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image16.png"  /> | You can double-click on the numerical value corresponding to the ID servo to modify it. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image17.png"  /> | Run the currently selected action. |
...
|:--:|:--:|
| **Icon** | **Function** |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image18.png"  /> | The time required to run a single action can be directly modified within the corresponding box. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image19.png"  /> | The time required to run the entire action group. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image20.png"  /> | Add the current servo values from the servo control area as a new action to the last row of the action details list. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image21.png"  /> | Replace the servo parameters of the selected action in the action details list with the current servo values from the servo control area, and replace the action runtime with the set value of "action time". |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image22.png"  /> | Insert a new action above the selected action in the action details list. Set the servo parameters to the values from the servo control area, and set the action time to the value of "action time". |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image23.png"  /> | Swap the selected action in the action details list with the action above it. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image24.png"  /> | Delete the selected action from the action details list. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image25.png"  /> | Delete all the action from the action details list. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image26.png"  /> | Swap the selected action in the action details list with the action below it. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image27.png"  /> | Run the selected action in the action details list once. Check "loop" to indicate looping the action. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image28.png"  /> | Open the action group file required for the action group. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image29.png"  /> | Save the action of the action details list to the specified position. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image30.png"  /> | By clicking the "Open Action File" button to open one action group, and then clicking this button again to open another action group, you can link them together. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image31.png"  /> | The saved action groups can be displayed in the PC software. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image32.png"  /> | Refresh the selected action group. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image33.png"  /> | Delete the currently selected action group file. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image34.png"  /> | (Caution) Delete all action group files. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image35.png"  /> | Execute the selected action group once. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image36.png"  /> | Stop the currently running action group. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image37.png"  /> | Exit PC software interface. |
...
| **Icon** | **Function** |
|:--:|:--:|
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image38.png"  /> | Save the adjusted deviation to the PuppyPi. |
| <img class="common_img" src="../_static/media/chapter_35\section_2/media/image39.png"  /> | Restore all servo values in the servo control area to 1500. |
...
<img class="common_img" src="../_static/media/chapter_35\section_2/media/image40.png"  />

If a situation like the one shown in the diagram below occurs, deviation adjustment is required.

<img class="common_img" src="../_static/media/chapter_35\section_2/media/image41.png"  />
...
(2) Click the icon <img class="common_img" src="../_static/media/chapter_35\section_3/media/image3.png"  /> on the upper left corner to open the Terminator terminal.
...
If the color recognition is inaccurate, please refer to "[20. ROS2-AI Vision and Tracking Course -> 20.1 Color Threshold Adjustment]()" for adjustment.
...
- **Source code program analysis**
  ...
  The source code of this program is stored at : [ros2_ws/src/example/example/puppy_with_arm/puppy_with_arm/include/color_detect_with_arm.py]().
...
(5) Refer to "[28.3.2 Operation Steps]()" to restart the program to check the modified game effects.
...
(2) Click the icon <img class="common_img" src="../_static/media/chapter_35\section_4/media/image3.png"  /> on the upper left corner to open the Terminator ROS2 terminal, and enter the following command to access the target file.
...
The source code of this program is saved in the Docker container: [ros2_ws/src/example/example/puppy_with_arm/color_grab.launch]()
...
The source code of the program is located in the Docker container at: [/home/ubuntu/ros2_ws/src/example/example/puppy_with_arm/include/color_grab.py]()
...
(5) Refer to "[28.4.2 Operation Steps]()" to restart the program to check the modified game effects.
...
(2) Click the icon <img class="common_img" src="../_static/media/chapter_35\section_5/media/image3.png"  /> to start the Terminator ROS2 terminal, then execute the following command to access the target file.
...
If the color recognition is inaccurate, you can refer to "[20. ROS2-AI Vision and Tracking Course -> 20.1 Color Threshold Adjustment]()" to adjust.
...
The source code of this program is stored at: [ros2_ws/src/example/example/puppy_with_arm/visual_patrol_with_arm.py]().
...
(5) Refer to "[28.5.2 Operation Steps]()" to restart the program to check the modified game effects.
...
(2) Click the icon <img class="common_img" src="../_static/media/chapter_35\section_6/media/image3.png"  /> on the upper left corner to open the Terminator ROS2 terminal. Then execute the following command to start the game.
...
- **Source Code Analysis**
  ...
  The source code for this program is located in the Docker container at : [ros2_ws/src/example/example/puppy_with_arm/hand_control_with_arm.py]()
...
(2) Click the icon <img class="common_img" src="../_static/media/chapter_35\section_7/media/image6.png"  /> on the upper left corner to open the Terminator ROS2 terminal.
...
(1) Click the icon <img class="common_img" src="../_static/media/chapter_35\section_8/media/image3.png"  /> on the left upper corner to open Terminator terminal.
...
(1) Click the icon <img class="common_img" src="../_static/media/chapter_35\section_8/media/image3.png"  /> on the left upper corner of the desktop to open the Terminator terminal.
...
(6) Refer to "[28.8.2 Operation Steps]()" to restart the game and view the effects of the modification.
